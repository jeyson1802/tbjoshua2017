...
$recipients = 'info@conferenciatbjoshuaperu.com';
//$recipients = '#';
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'contacto@conferenciatbjoshuaperu.com';
    $mail->Password = 'alaska94';
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;

    $mail->From = 'contacto@conferenciatbjoshuaperu.com';
