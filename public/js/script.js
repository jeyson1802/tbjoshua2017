...
(function ($) {
    ...
    if (o) {
        include('http://maps.google.com/maps/api/js?key=AIzaSyAGSZx5EHqC4Hz_dOEYcmoVTso0irEd85Y');
            ...
            if (o.length) {
                o.rdMailForm({
                    validator: {
                        'constraints': {
                            '@LettersOnly': {
                                message: 'Por favor ingrese sólo letras'
                            },
                            '@NumbersOnly': {
                            ...
                            '@Date': {
                                message: 'Usar MM/DD/YYYY como formato'
                            },
                            '@SelectRequired': {
