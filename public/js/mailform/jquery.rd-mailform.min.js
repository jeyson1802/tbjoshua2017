...
!function (e) {
    ...
    t.Defaults = {progress: {applyTo: ".mfInfo", "class": "mfProgress"}}, t.prototype.initialize = function () {
        ...
        t._core.$element.on("mf.process", function () {
            e(this).find("." + t._core.options.progress["class"]).removeClass("hide").addClass("sending").find(".msg").text("Enviando...")
        }).on("mf.fail", function (i, o) {
            e(this).find("." + t._core.options.progress["class"]).removeClass("sending").addClass("fail").find(".msg").text("Hubo un problema, por favor vuelva a intentarlo."), setTimeout(e.proxy(function () {
